    ...
    <div className="w-full min-w-0 space-y-6">
      ...
      <div>
        <div className="flex items-center gap-3 min-w-0">
          <div className="p-2.5 bg-primary-container/40 text-luminous-highlight border border-glass-border shadow-[0_0_10px_rgba(var(--accent-rgb),0.2)]">
      ...
      {/* Upload Zone */}
      <div className="glass-panel p-6 border border-glass-border shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
      ...
      {uploadErrors.length > 0 && (
        <div role="alert" className="space-y-1 border border-rose-500/30 bg-rose-500/10 p-4 text-xs font-semibold text-rose-300">
